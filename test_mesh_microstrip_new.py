"""
Headless meshing test for Microstrip_test_new.FCStd.

Run with:
    freecadcmd /workspace/test_mesh_microstrip_new.py
"""
...
FCStd = "/workspace/Microstrip_test_new.FCStd"
...
for obj in doc.Objects:
    ...
    for prop in ["SimulationType", "OuterBoundaryType", "Group", "PortIndex",
                 "PortGeometryType", "Permittivity", "ConductorType",
                 "MeshAttribute", "MeshCharacteristicLengthMax"]:
        if hasattr(obj, prop):
...
try:
    ...
    if tet10 == 0:
        print("[test] FAIL: no tet10 volume elements")
        sys.exit(1)
    else:
