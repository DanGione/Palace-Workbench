...
# Start TigerVNC with no authentication — the devcontainer port-forward is the security boundary.
...
printf '║                                                                                  ║\n'
printf '║  Browser: http://localhost:6080/vnc.html?autoconnect=1&resize=remote             ║\n'
